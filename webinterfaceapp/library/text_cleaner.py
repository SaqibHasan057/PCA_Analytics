...
class TweetCleaner:
    ...
    def get_cleaned_text(self, text):
        ...
        tokens = [w.translate(self.punc_table) for w in tk.tokenize(cleaned_text)]  # remove punctuations and tokenize
    ...
    def get_cleaned_tweet(self, tweet):
        ...
        if not tweet['in_reply_to_status_id'] == None or not tweet[
                                                                 'in_reply_to_user_id'] == None: return None  # remove comments of any tweet
